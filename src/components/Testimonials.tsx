...
const TestimonialCard = ({
  ...
  return (
    <Card className="h-full overflow-hidden transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
      <div 
        className="h-full flex flex-col justify-between bg-cover bg-center p-6 text-white relative" 
        style={{
          backgroundImage: `url('${backgroundImage}')`
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-tr from-black/70 via-black/50 to-transparent z-0"></div>
        
        <div className="relative z-10">
          <svg className="w-8 h-8 mb-4 text-yellow-400" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
...
const Testimonials = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-druk-100/20 rounded-full blur-3xl -z-10"></div>
      <div className="absolute -top-24 -left-24 w-64 h-64 bg-druk-100/10 rounded-full blur-3xl -z-10"></div>
    </section>
  );
};
